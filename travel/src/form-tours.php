...
//    correo donde tienen que llegar los correos
    $elhotel ="naranjojose256@gmail.com";
    //$elhotel ="info@southamerica-expeditions.com";
    $im=$_SESSION['securimage_code_value'];
    $seg = strtolower($_POST["segur"]);
    $body = "<html>";
    $body .= "<p><strong>";
    $body .= "Book This Tour - Southamerica Expeditions";
    $body .= "</strong></p>\n";
    if($_POST["tour"]) $body .= "<strong>TOUR</strong>: " . $_POST["tour"] . "<br>\n";
	...
	if($_POST["date_in"]) $body .= "<strong>TOUR DAY</strong>: " . $_POST["date_in"] . "<br>\n";
	if($_POST["personas"]) $body .= "<strong>NUMBER PERSONS</strong>: " . $_POST["personas"] . "<br>\n";
	if($_POST["mensaje"]) $body .= "<strong>MESSAGE</strong>: " . $_POST["mensaje"] . "<br>\n";
    $body .= "</html>";
    $asunto = "Book This Tour - Southamerica Expeditions";
